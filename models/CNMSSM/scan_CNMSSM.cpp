...
int main(int argc, char* argv[])
{
   ...
   CNMSSM_spectrum_generator<algorithm_type> spectrum_generator;
   ...
   for (std::vector<double>::const_iterator it = range.begin(),
      ...
      const CNMSSM<algorithm_type>& model = spectrum_generator.get_model();
      const CNMSSM_physical& pole_masses = model.get_physical();
      const Problems<CNMSSM_info::NUMBER_OF_PARTICLES>& problems
