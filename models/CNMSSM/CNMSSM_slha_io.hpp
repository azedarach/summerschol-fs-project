...
public:
   ...
   template <class T> void fill(CNMSSM<T>&) const;
   ...
   template <class T> void set_extra(const CNMSSM<T>&);
   void set_minpar(const CNMSSM_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const CNMSSM<T>&);
   void set_spinfo(const Problems<CNMSSM_info::NUMBER_OF_PARTICLES>&);
...
private:
   ...
   static void convert_to_slha_convention(CNMSSM_physical&);
   void set_mass(const CNMSSM_physical&, bool);
   void set_mixing_matrices(const CNMSSM_physical&, bool);
   template <class T> void set_model_parameters(const CNMSSM<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(CNMSSM<T>&) const;
   template <class T> void fill_physical(CNMSSM<T>&) const;
};
 ...
 */
template <class T>
void CNMSSM_slha_io::fill(CNMSSM<T>& model) const
{
 ...
 */
template <class T>
void CNMSSM_slha_io::fill_drbar_parameters(CNMSSM<T>& model) const
{
 ...
 */
template <class T>
void CNMSSM_slha_io::fill_physical(CNMSSM<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
 ...
 */
template <class T>
void CNMSSM_slha_io::set_model_parameters(const CNMSSM<T>& model)
{
   {
 ...
 */
template <class T>
void CNMSSM_slha_io::set_extra(const CNMSSM<T>& model)
{
   CNMSSM_physical physical(model.get_physical());
