...
// ====================================================================
/**
 * @file CNMSSM_two_scale_model.hpp
...
#ifndef CNMSSM_TWO_SCALE_H
#define CNMSSM_TWO_SCALE_H
 ...
 */
template<>
class CNMSSM<Two_scale> : public Two_scale_model, public CNMSSM_soft_parameters {
public:
   ...
   Problems<CNMSSM_info::NUMBER_OF_PARTICLES>& get_problems();
...
private:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(CNMSSM<Two_scale>::*Memfun_t)();
      CNMSSM<Two_scale>* model;
      Memfun_t fun;

      Thread(CNMSSM<Two_scale>* model_, Memfun_t fun_)
   ...
   Problems<CNMSSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const CNMSSM<Two_scale>&);
