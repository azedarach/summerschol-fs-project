...
#ifndef CNMSSM_TWO_SCALE_susy_parameters_H
#define CNMSSM_TWO_SCALE_susy_parameters_H
...
public:
   ...
   CNMSSM_susy_parameters(double scale_, double loops_, double thresholds_, const CNMSSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   ...
   virtual ~CNMSSM_susy_parameters() {}
