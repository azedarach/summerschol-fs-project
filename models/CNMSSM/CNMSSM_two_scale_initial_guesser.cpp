...
CNMSSM_initial_guesser<Two_scale>::CNMSSM_initial_guesser(
   CNMSSM<Two_scale>* model_,
   const CNMSSM_input_parameters& input_pars_,
   const QedQcd& oneset_,
   const CNMSSM_low_scale_constraint<Two_scale>& low_constraint_,
   const CNMSSM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const CNMSSM_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "CNMSSM_initial_guesser: Error: pointer to model"
          " CNMSSM<Two_scale> must not be zero");
}
 ...
 */
void CNMSSM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void CNMSSM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void CNMSSM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void CNMSSM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void CNMSSM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void CNMSSM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void CNMSSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
