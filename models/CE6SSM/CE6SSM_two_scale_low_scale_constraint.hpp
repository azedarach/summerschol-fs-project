...
#ifndef CE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define CE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
...
template<>
class CE6SSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   CE6SSM_low_scale_constraint();
   CE6SSM_low_scale_constraint(const CE6SSM_input_parameters&, const QedQcd&);
   virtual ~CE6SSM_low_scale_constraint();
   virtual void apply();
