...
CE6SSM_initial_guesser<Two_scale>::CE6SSM_initial_guesser(
   CE6SSM<Two_scale>* model_,
   const CE6SSM_input_parameters& input_pars_,
   const QedQcd& oneset_,
   const CE6SSM_low_scale_constraint<Two_scale>& low_constraint_,
   const CE6SSM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const CE6SSM_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "CE6SSM_initial_guesser: Error: pointer to model"
          " CE6SSM<Two_scale> must not be zero");
}
 ...
 */
void CE6SSM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void CE6SSM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void CE6SSM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void CE6SSM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void CE6SSM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void CE6SSM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void CE6SSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
