 ...
 */
double CE6SSM_soft_parameters::calc_beta_mHp2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CE6SSM_soft_parameters::calc_beta_mHp2_two_loop(const Soft_traces& soft_traces) const
{
