...
// ====================================================================
/**
 * @file CE6SSM_two_scale_model.hpp
...
#ifndef CE6SSM_TWO_SCALE_H
#define CE6SSM_TWO_SCALE_H
...
class Two_scale;
/**
 * @class CE6SSM<Two_scale>
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
template<>
class CE6SSM<Two_scale> : public Two_scale_model, public CE6SSM_soft_parameters {
public:
   ...
   Problems<CE6SSM_info::NUMBER_OF_PARTICLES>& get_problems();
...
private:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(CE6SSM<Two_scale>::*Memfun_t)();
      CE6SSM<Two_scale>* model;
      Memfun_t fun;

      Thread(CE6SSM<Two_scale>* model_, Memfun_t fun_)
   ...
   Problems<CE6SSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const CE6SSM<Two_scale>&);
