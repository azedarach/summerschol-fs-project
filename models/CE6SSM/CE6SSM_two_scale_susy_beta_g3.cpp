 ...
 */
double CE6SSM_susy_parameters::calc_beta_g3_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CE6SSM_susy_parameters::calc_beta_g3_two_loop(const Susy_traces& susy_traces) const
{
