...
// File generated at Fri 9 Jan 2015 15:08:51
 ...
 */
Eigen::Array<double,2,1> CLASSNAME::get_soft_gaugino_mass_coeffs(CMSSM_info::Parameters gaugino_mass,
                                                                 double low_scale, double high_scale) const
{
   ...
   CMSSM_soft_parameters run_model;
 ...
 */
Eigen::Array<double,4,1> CLASSNAME::get_soft_scalar_mass_coeffs(CMSSM_info::Parameters soft_mass,
                                                                double low_scale, double high_scale) const
{
   const auto m0 = LOCALINPUT(m0);
   const auto m12 = LOCALINPUT(m12);
...
double CLASSNAME::get_soft_mass_squared(const CMSSM_soft_parameters& model, CMSSM_info::Parameters soft_mass) const
{
   double mass2;
   switch(soft_mass) {
   case CMSSM_info::mq200: {
 ...
 */
Eigen::Array<double,2,1> CLASSNAME::get_soft_trilinear_coeffs(CMSSM_info::Parameters soft_trilinear, 
                                                              double low_scale, double high_scale) const
{
   const auto m0 = LOCALINPUT(m0);
   const auto m12 = LOCALINPUT(m12);
   ...
   double trilinear_pt1;
   switch(soft_trilinear) {
   case CMSSM_info::TYe00: {
      trilinear_pt1 = run_model.get_TYe(0,0);
      break;
   }
   case CMSSM_info::TYe01: {
      trilinear_pt1 = run_model.get_TYe(0,1);
      break;
   }
   case CMSSM_info::TYe02: {
      trilinear_pt1 = run_model.get_TYe(0,2);
      break;
   }
   case CMSSM_info::TYe10: {
      trilinear_pt1 = run_model.get_TYe(1,0);
      break;
   }
   case CMSSM_info::TYe11: {
      trilinear_pt1 = run_model.get_TYe(1,1);
      break;
   }
   case CMSSM_info::TYe12: {
      trilinear_pt1 = run_model.get_TYe(1,2);
      break;
   }
   case CMSSM_info::TYe20: {
      trilinear_pt1 = run_model.get_TYe(2,0);
      break;
   }
   case CMSSM_info::TYe21: {
      trilinear_pt1 = run_model.get_TYe(2,1);
      break;
   }
   case CMSSM_info::TYe22: {
      trilinear_pt1 = run_model.get_TYe(2,2);
      break;
   }

   case CMSSM_info::TYd00: {
      trilinear_pt1 = run_model.get_TYd(0,0);
      break;
   }
   case CMSSM_info::TYd01: {
      trilinear_pt1 = run_model.get_TYd(0,1);
      break;
   }
   case CMSSM_info::TYd02: {
      trilinear_pt1 = run_model.get_TYd(0,2);
      break;
   }
   case CMSSM_info::TYd10: {
      trilinear_pt1 = run_model.get_TYd(1,0);
      break;
   }
   case CMSSM_info::TYd11: {
      trilinear_pt1 = run_model.get_TYd(1,1);
      break;
   }
   case CMSSM_info::TYd12: {
      trilinear_pt1 = run_model.get_TYd(1,2);
      break;
   }
   case CMSSM_info::TYd20: {
      trilinear_pt1 = run_model.get_TYd(2,0);
      break;
   }
   case CMSSM_info::TYd21: {
      trilinear_pt1 = run_model.get_TYd(2,1);
      break;
   }
   case CMSSM_info::TYd22: {
      trilinear_pt1 = run_model.get_TYd(2,2);
      break;
   }

   case CMSSM_info::TYu00: {
      trilinear_pt1 = run_model.get_TYu(0,0);
      break;
   }
   case CMSSM_info::TYu01: {
      trilinear_pt1 = run_model.get_TYu(0,1);
      break;
   }
   case CMSSM_info::TYu02: {
      trilinear_pt1 = run_model.get_TYu(0,2);
      break;
   }
   case CMSSM_info::TYu10: {
      trilinear_pt1 = run_model.get_TYu(1,0);
      break;
   }
   case CMSSM_info::TYu11: {
      trilinear_pt1 = run_model.get_TYu(1,1);
      break;
   }
   case CMSSM_info::TYu12: {
      trilinear_pt1 = run_model.get_TYu(1,2);
      break;
   }
   case CMSSM_info::TYu20: {
      trilinear_pt1 = run_model.get_TYu(2,0);
      break;
   }
   case CMSSM_info::TYu21: {
      trilinear_pt1 = run_model.get_TYu(2,1);
      break;
   }
   case CMSSM_info::TYu22: {
      trilinear_pt1 = run_model.get_TYu(2,2);
      break;
   }
   ...
   double trilinear_pt2;
   switch(soft_trilinear) {
   case CMSSM_info::TYe00: {
      trilinear_pt2 = run_model.get_TYe(0,0);
      break;
   }
   case CMSSM_info::TYe01: {
      trilinear_pt2 = run_model.get_TYe(0,1);
      break;
   }
   case CMSSM_info::TYe02: {
      trilinear_pt2 = run_model.get_TYe(0,2);
      break;
   }
   case CMSSM_info::TYe10: {
      trilinear_pt2 = run_model.get_TYe(1,0);
      break;
   }
   case CMSSM_info::TYe11: {
      trilinear_pt2 = run_model.get_TYe(1,1);
      break;
   }
   case CMSSM_info::TYe12: {
      trilinear_pt2 = run_model.get_TYe(1,2);
      break;
   }
   case CMSSM_info::TYe20: {
      trilinear_pt2 = run_model.get_TYe(2,0);
      break;
   }
   case CMSSM_info::TYe21: {
      trilinear_pt2 = run_model.get_TYe(2,1);
      break;
   }
   case CMSSM_info::TYe22: {
      trilinear_pt2 = run_model.get_TYe(2,2);
      break;
   }

   case CMSSM_info::TYd00: {
      trilinear_pt2 = run_model.get_TYd(0,0);
      break;
   }
   case CMSSM_info::TYd01: {
      trilinear_pt2 = run_model.get_TYd(0,1);
      break;
   }
   case CMSSM_info::TYd02: {
      trilinear_pt2 = run_model.get_TYd(0,2);
      break;
   }
   case CMSSM_info::TYd10: {
      trilinear_pt2 = run_model.get_TYd(1,0);
      break;
   }
   case CMSSM_info::TYd11: {
      trilinear_pt2 = run_model.get_TYd(1,1);
      break;
   }
   case CMSSM_info::TYd12: {
      trilinear_pt2 = run_model.get_TYd(1,2);
      break;
   }
   case CMSSM_info::TYd20: {
      trilinear_pt2 = run_model.get_TYd(2,0);
      break;
   }
   case CMSSM_info::TYd21: {
      trilinear_pt2 = run_model.get_TYd(2,1);
      break;
   }
   case CMSSM_info::TYd22: {
      trilinear_pt2 = run_model.get_TYd(2,2);
      break;
   }

   case CMSSM_info::TYu00: {
      trilinear_pt2 = run_model.get_TYu(0,0);
      break;
   }
   case CMSSM_info::TYu01: {
      trilinear_pt2 = run_model.get_TYu(0,1);
      break;
   }
   case CMSSM_info::TYu02: {
      trilinear_pt2 = run_model.get_TYu(0,2);
      break;
   }
   case CMSSM_info::TYu10: {
      trilinear_pt2 = run_model.get_TYu(1,0);
      break;
   }
   case CMSSM_info::TYu11: {
      trilinear_pt2 = run_model.get_TYu(1,1);
      break;
   }
   case CMSSM_info::TYu12: {
      trilinear_pt2 = run_model.get_TYu(1,2);
      break;
   }
   case CMSSM_info::TYu20: {
      trilinear_pt2 = run_model.get_TYu(2,0);
      break;
   }
   case CMSSM_info::TYu21: {
      trilinear_pt2 = run_model.get_TYu(2,1);
      break;
   }
   case CMSSM_info::TYu22: {
      trilinear_pt2 = run_model.get_TYu(2,2);
      break;
   }
...
void CLASSNAME::calculate_MVZ()
{
   ...
   problems.flag_tachyon(CMSSM_info::VZ, MVZ < 0.);
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_tachyon(CMSSM_info::Sd, MSd.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_tachyon(CMSSM_info::Sv, MSv.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_tachyon(CMSSM_info::Su, MSu.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_tachyon(CMSSM_info::Se, MSe.minCoeff() < 0.);
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_tachyon(CMSSM_info::hh, Mhh.minCoeff() < 0.);
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_tachyon(CMSSM_info::Ah, MAh.minCoeff() < 0.);
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_tachyon(CMSSM_info::Hpm, MHpm.minCoeff() < 0.);
...
void CLASSNAME::calculate_MVWm()
{
   ...
   problems.flag_tachyon(CMSSM_info::VWm, MVWm < 0.);
